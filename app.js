...
import { TransformControls } from 'https://cdn.jsdelivr.net/npm/three@0.164.1/examples/jsm/controls/TransformControls.js';
...
// 依存ライブラリは CDN から読み込むため、ファイルを直接ブラウザで開くだけで動作します。
// オフラインで使用する場合は、各スクリプトをダウンロードしてパスを書き換えてください。
...
// Helpers
const gridHelper = new THREE.GridHelper(60, 60, 0x1f2937, 0x0f172a);
const axesHelper = new THREE.AxesHelper(2.5);
scene.add(gridHelper);
scene.add(axesHelper);

// Ground plane for snapping and shadows
const groundMat = new THREE.MeshStandardMaterial({ color: 0x0b1220, transparent: true, opacity: 0.65, roughness: 1 });
